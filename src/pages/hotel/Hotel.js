      ...
      <div className="hotelContainer">
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighLight">
            Book a stay over ₹8000 at this property and get a free airport taxi.
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Located a 5-minute walk from Red Fort, Tower Street Apartments
                has accommodations with air conditioning and free WiFi. The
                ...
                Market Square and Town Hall Tower. The nearest airport is Indira
                Gandhi International airport New Dlehi, 16.1 km from Tower
